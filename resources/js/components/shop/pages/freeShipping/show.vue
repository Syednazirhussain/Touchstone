						...
						<div class="col-md-12" v-if="isLoaded">
						    <div class="box box-primary">
								<div class="box-header with-border">
								    <h3 class="box-title" v-if="isFound">Free Shipping</h3>
								    <div class="box-tools">
	...
	export default {
		...
		methods: {
			...
			async getCountry (id) {
	    		...
	    		let urlArr = _.split(window.touchStone.routes.shop_admin_fsbar_show, '/', 3)
				let url = _.join(urlArr, '/')+'/'+id

				await axios.get(url).then(response => {

					this.isLoaded = true
					this.freeShipping = response.data.payload
