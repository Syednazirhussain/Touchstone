			...
			<div class="content-wrapper">
				<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li>
							<a href="javascript:void(0);">Bundle Product</a>
						</li>
					</ol>
				</section>
						...
						<div class="col-md-12" v-if="isLoaded">
						    <div class="box box-primary">
								<div class="box-header with-border">
								    <h3 class="box-title" v-if="isFound">{{ bundle.title.en }}</h3>
								    <div class="box-tools">
									    ...
									    <div class="panel-body" v-if="isFound">
									    	...
									    	<form @submit.prevent="update" enctype="multipart/form-data">
									    		...
									    		<div class="col-md-12 form-group">
									    			...
									    			<div class="col-md-4 pull-left">
									    				<select class="form-control" v-model="bundle.product_id">
									    					<option :value="product.id" v-for="(product, index) in products" :key="index" :selected="bundle.product_id == product.id">
									    		...
									    		<div class="col-md-12 form-group">
									    			...
									    			<div class="col-md-4 pull-left">
									    				<select class="form-control" v-model="bundle.bundle_product_id">
									    					<option :value="product.id" v-for="(product, index) in products" :key="index" :selected="bundle.bundle_product_id == product.id">
									    						{{ getText(product.title) }}
									    					</option>
									    				</select>
									    			</div>
									    		...
									    		<div class="col-md-12 form-group">
									    			...
									    			<div class="col-md-4 pull-left">
									    				<input type="text" v-model="bundle.count_product" class="form-control">
									    			</div>
									    		</div>
									    		...
									    		<div class="col-md-12 form-group">
									    			...
									    			<div class="col-md-4 pull-left">
									    				<input type="text" v-model="bundle.order" class="form-control">
									    			</div>
									    		</div>
	...
	export default {
		...
		methods: {
			...
			async getBundleProduct (id) {
	    		...
	    		let urlArr = _.split(window.touchStone.routes.shop_admin_product_bundle_edit, '/', 3)
				let url = _.join(urlArr, '/')+ '/' +this.product_id+ '/bundles/' +id+ '/edit'

				await axios.get(url).then(response => {

					this.isLoaded = true
					this.products = response.data.payload.products
					this.bundle = response.data.payload.bundle
					...
					this.bundle.title 		= JSON.parse(this.bundle.title)
					this.bundle.price_text 	= JSON.parse(this.bundle.price_text)
			...
			async update () {
	    		...
	    		let urlArr = _.split(window.touchStone.routes.shop_admin_product_bundle_update, '/', 3)
				let url = _.join(urlArr, '/')+ '/' +this.product_id+ '/bundles/' +this.id+ '/update'

				await axios.put(url, this.bundle).then(response => {
