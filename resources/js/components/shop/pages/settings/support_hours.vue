			...
			<div class="content-wrapper">
				<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li>
							<a href="javascript:void(0);">Support Hours</a>
						</li>
					</ol>
				</section>
									    ...
									    <div class="panel-body" v-if="isFound">
									    	...
									    	<form @submit.prevent="update" enctype="multipart/form-data">
									    		...
									    		<div class="col-md-12 form-group">
									    			<div class="col-md-4">
									    				<label>Support Hours en</label>
									    			</div>
									    			<div class="col-md-4 pull-left">
									    				<vue-editor v-model="settings.hours.en" :editor-toolbar="customToolbar" />
									    			</div>
									    		</div>

									    		<div class="col-md-12 form-group">
									    			<div class="col-md-4">
									    				<label>Support Hours pl</label>
									    			</div>
									    			<div class="col-md-4 pull-left">
									    				<vue-editor v-model="settings.hours.pl" :editor-toolbar="customToolbar" />
									    			</div>
									    		</div>

									    		<div class="col-md-12 form-group">
									    			<div class="col-md-4">
									    				<label>Support Hours ja</label>
									    			</div>
									    			<div class="col-md-4 pull-left">
									    				<vue-editor v-model="settings.hours.ja" :editor-toolbar="customToolbar" />
									    			</div>
									    		</div>

									    		<div class="col-md-12 form-group">
									    			<div class="col-md-4">
									    				<label>Support Hours es</label>
									    			</div>
									    			<div class="col-md-4 pull-left">
									    				<vue-editor v-model="settings.hours.es" :editor-toolbar="customToolbar" />
									    			</div>
									    		</div>

									    		<div class="col-md-12 form-group">
									    			<div class="col-md-4">
									    				<label>Support Hours th</label>
									    			</div>
									    			<div class="col-md-4 pull-left">
									    				<vue-editor v-model="settings.hours.th" :editor-toolbar="customToolbar" />
									    			</div>
									    		</div>
		...
		methods: {
			...
			async getSettings (id) {
				...
				await axios.get(url).then(response => {
					...
					this.settings.hours = JSON.parse(this.settings.hours)
				})
			},
			async update () {
