...
class AddressesController extends Controller
{
    ...
    {
        $addresses = $this->addressesRepository->index();
        return response([ 'payload' => $addresses ], 200);
    }
    ...
    {
        $address = $this->addressesRepository->show($id);
        return response([ 'payload' => $address ], 200);
    }
